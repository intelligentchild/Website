            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand">
                        <a class="logo" href="{{ url('/') }}"><img src="/img/logo1.png" alt="logo"/>LAXMI NARAYAN TRUST</a>
                    </div>
                    <!-- Logo -->
                ...
                <ul class="navbar-menu nav navbar-nav navbar-right">
                    ...
                    @if (Auth::guest())
                    <li  class="has-dropdown"><a href="#" title="Only for Admin"><i class="fa fa-user-circle-o" style="font-size:20px"></i></a>
                        <ul class="dropdown">
                    ...
                    @else 
                        ...
                        <ul class="dropdown-menu" role="menu" >
                            <li><a href ="/home" style="color:black">DashBoard</a></li>
                                <li>
                                    <a href="{{ route('logout') }}"
	...
	<footer id="footer" class="section">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="footer">
                        <h3 class="footer-title" ><a href="/photos">Gallery</a></h3>
